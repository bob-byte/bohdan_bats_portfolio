import 'package:bohdan_bats_portfolio/components/experience/experience_item.dart';
import 'package:bohdan_bats_portfolio/components/experience/portfolio_experiences.dart';
import 'package:bohdan_bats_portfolio/imports.dart';
import 'package:bohdan_bats_portfolio/views/mobile/drawer_mobile.dart';
import 'package:bohdan_bats_portfolio/views/mobile/experience_expandable_card.dart';
import 'package:bohdan_bats_portfolio/views/mobile/experience_stats_row.dart';
import 'package:bohdan_bats_portfolio/view_models/experience_expansion_view_model.dart';
...
class ExperienceMobile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (_) => ExperienceExpansionViewModel(),
      child: Scaffold(
        ...
        body: Consumer<ExperienceExpansionViewModel>(
                ...
                ...List.generate(
                  ...
                  (i) => Padding(
                    ...
                    child: ExperienceExpandableCard(
                      item: _experiences[i],
                      expanded: expansion.expandedIndex == i,
                      onHeaderTap: () => expansion.toggle(i),
                    ),
                  ),
                ),
              ],
